    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("chain_id", models.PositiveIntegerField(blank=True, unique=True, verbose_name="Chain ID")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "account",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="chains.account", verbose_name="账户"
                    ),
                ),
                (
                    "network",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="chains.network", verbose_name="主网"
                    ),
                ),
            ],
            options={
                "verbose_name": "内部账户交易队列",
                "verbose_name_plural": "内部账户交易队列",
                "ordering": ("created_at",),
            },
        ),
        migrations.CreateModel(
