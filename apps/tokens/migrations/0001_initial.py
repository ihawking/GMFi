    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("active", models.BooleanField(default=True, help_text="是否启用本代币", verbose_name="启用")),
                (
                    "chain",
                    models.ForeignKey(
        ...
        migrations.AddField(
            model_name="token",
            name="chains",
            field=models.ManyToManyField(related_name="tokens", through="tokens.TokenAddress", to="chains.chain"),
        ),
        migrations.CreateModel(
            name="TokenTransfer",
            fields=[
